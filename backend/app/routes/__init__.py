...
__all__ = ["auth_router", "words_router", "study_router", "games_router", "stats_router", "videos_router", "sentences_router", "admin_router", "texts_router", "exams_router", "conversation_router", "support_router"]
